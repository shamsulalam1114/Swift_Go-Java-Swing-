...
public class PaymentRocket extends JFrame implements ActionListener {
    ...
    public PaymentRocket() {
        ...
        mycolor = new Color(169, 39, 181);
        panel.setBackground(mycolor);

        name3 = new JLabel("Rocket Payment");
        name3.setBounds(700, 100, 120, 50);
        panel.add(name3);
        amount3 = new JLabel("Amount:");
        amount3.setBounds(600, 220, 60, 50);
        panel.add(amount3);
        nagadno1 = new JLabel("Enter Rocket Number:");
        nagadno1.setBounds(600, 280, 180, 50);
        panel.add(nagadno1);
        pin2 = new JLabel("Enter Rocket Pin:");
        ...
        rocket = new JLabel();
        ImageIcon rocketlogo = new ImageIcon("D:/JAVA Code/SwiftGo/Frame1/Pictures/unnamed.png");
        rocket.setIcon(rocketlogo);

        rocket.setBackground(mycolor); // Fix: Set background color for the JLabel
        rocket.setBounds(0, 0, 600, 800);
        panel.add(rocket);
