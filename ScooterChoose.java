...
public class ScooterChoose extends JFrame implements ActionListener {
    JPanel panel, panel2, panel3, panel4, panel5;
    JButton back,next;
JCheckBox ch55,ch66,ch77,ch88;
    ImageIcon icon8;

    Color mycolor, mycolor66;

    public ScooterChoose() {
        super("ScooterChoose");
        ...
        JLabel mobileLabel1 = new JLabel("Mobile Number:");
          ch55 = new JCheckBox("Select");
           ch55.setBounds(250, 250, 100, 30);
                 panel2.add(ch55);
        nameLabel1.setBounds(250, 10, 100, 20);
        addressLabel1.setBounds(250, 40, 100, 20);
        mobileLabel1.setBounds(250, 70, 100, 20);
       
        JLabel driverImageLabel1 = new JLabel(new ImageIcon("D:\\JAVA Code\\SwiftGo\\Frame1\\Pictures\\s2.png"));
	  ...
	  ch66 = new JCheckBox("Select");
           ch66.setBounds(250, 250, 100, 30);
                 panel3.add(ch66);
        ...
        JLabel driverImageLabel2 = new JLabel(new ImageIcon("D:\\JAVA Code\\SwiftGo\\Frame1\\Pictures\\s1.png"));
        ...
        JLabel mobileLabel3 = new JLabel("Mobile Number:");
	     ...
	     ch77 = new JCheckBox("Select");
           ch77.setBounds(290, 250, 100, 30);
                 panel4.add(ch77);
        ...
        JLabel driverImageLabel3 = new JLabel(new ImageIcon("D:\\JAVA Code\\SwiftGo\\Frame1\\Pictures\\s4.png"));
	  ...
	  ch88 = new JCheckBox("Select");
           ch88.setBounds(290, 250, 100, 30);
                 panel5.add(ch88);
        ...
        JLabel driverImageLabel4 = new JLabel(new ImageIcon("D:\\JAVA Code\\SwiftGo\\Frame1\\Pictures\\scoter.png"));
...
public void actionPerformed(ActionEvent ae) {
    ...
    if (ch55.isSelected() ^ ch66.isSelected() ^ ch77.isSelected() ^ ch88.isSelected()) {
        PaymentMethod pm1 = new PaymentMethod();
        pm1.setVisible(true);
        this.setVisible(false);
    } else {
        JOptionPane.showMessageDialog(this, "Please Select One Scooter.");
    }
