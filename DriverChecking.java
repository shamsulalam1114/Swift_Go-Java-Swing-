...
public class DriverChecking extends JFrame implements ActionListener
...

{
	...
	Font myFont;
	Color c1;
	public DriverChecking(String username, Frame1 f1)
	{
		super("Driver Checking");
	...
	this.f1=f1;
		...
		userLabel = new JLabel("Did you reached the location Safely? ");
		...
		userLabel2 = new JLabel("Are You Facing Any Issues With Your passengers? ");
		userLabel2.setBounds(100,360,950, 30);
		...
		a1=new JCheckBox("passenger is a criminal");
		a1.setBounds(100,400,250,40);
		a1.setBackground(c1);
		...
		a2=new JCheckBox("passenger didnt able to set the location");
		a2.setBounds(100,440,400,40);
		a2.setFont(new Font("Cambria", Font.PLAIN, 20));
		a2.setBackground(c1);
		a2.setFocusable(false);
		panel.add(a2);
		
		a3=new JCheckBox("passenger started bargain");
		a3.setBounds(100,480,250,40);
